                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <form method="POST" action="{{ url('/admin/update-admin-details') }}"
                                enctype="multipart/form-data" name="updateAdminDetailsForm" id='updatePasswordForm'>
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('admin_mobile') is-invalid @enderror"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file"
                                            class="form-control p-1 @error('admin_image') is-invalid @enderror"
                                            name="admin_image" id='admin_image' accept="image/*">
                                        @error('admin_image')
                                            <small class="text text-danger">{{ $message }}</small>
                                        @enderror
